...
[![Version](https://img.shields.io/badge/version-0.8.6-orange.svg)](https://github.com/MPunktBPunkt/pidrive/blob/main/pidrive/VERSION)
...
```
PiDrive  (v0.8.6 — Baumbasiert, beliebig tief)
├── Jetzt laeuft
│   ├── Quelle / Titel         (info)
...
| ✅ Erledigt | Audio-Routing (Webradio/FM/DAB auf BT) | v0.8.6 |
