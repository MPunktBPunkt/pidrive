...
# pidrive_display.service: entfernt v0.11.68
...
# ══════════════════════════════════════════════════════════════
# Audio-Konfiguration: PipeWire System-Mode (v0.11.68)
# ══════════════════════════════════════════════════════════════
...
_mods = [
    ...
    'modules.audio','modules.wifi','modules.system',
    'modules.webradio','modules.favorites',
    'modules.radio.dab','modules.radio.fm','modules.radio.scanner',
    'modules.radio.rtlsdr','modules.radio.spectrum','modules.radio.dab_scan',
    'modules.bluetooth.bt_connect','modules.bluetooth.bt_helpers',
    'modules.bluetooth.bt_audio','modules.bluetooth.bt_watcher',
...
# Runtime-Stabilitaetsfenster: 15s beobachten (Review v0.11.68)
