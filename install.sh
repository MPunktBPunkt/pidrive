...
# pidrive_display.service: entfernt v0.11.60
...
# ══════════════════════════════════════════════════════════════
# Audio-Konfiguration: PipeWire System-Mode (v0.11.60)
# ══════════════════════════════════════════════════════════════
...
# Runtime-Stabilitaetsfenster: 15s beobachten (Review v0.11.60)
