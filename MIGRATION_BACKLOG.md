...
**Stand v0.11.48 · Arbeitsorientiertes Migrationsdokument**
...
| `trigger/` | ✅ fast fertig | sauber seit v0.11.48 | keine aktiven | abgeschlossen erklären |
...
| `core/` (main_core) | ⚠️ noch fragil | bereinigt v0.11.48 | Root-Entry bleibt | erst logisch zerlegen |
...
|---|---|---|---|---|---|
| `main_core.py` | `pidrive_core.service` | systemd, alle Importe | Core-Logik zu eng verzahnt, Hochrisiko-Move | Erst logisch zerlegen, `core_callbacks.py` vervollständigen | P1 (nach v0.11.48) |
| `webui.py` | `pidrive_web.service` | systemd | Flask-Startkontext | Service auf `web/app.py` umstellen | P1 (v0.11.48) |
| `avrcp_trigger.py` | `pidrive_avrcp.service` | systemd | Service-Einstieg | `integration/avrcp_trigger.py` kanonisieren, dann Service umstellen | P1 (v0.11.48) |
...
### Block 1: `trigger/` abschließen — ✅ erledigt in v0.11.48
...
### Block 2: IPC-Producer vereinheitlichen — ✅ erledigt in v0.11.48/27
...
### Block 3: `integration/` kanonisieren — 🔄 geplant v0.11.48
...
### Block 4: Web-Entry ablösen — 🔄 geplant v0.11.48
...
### Block 5: `main_core.py` logisch zerlegen — 📅 geplant v0.11.48+
...
### Block 6: Systemd Core-Entrypoint modernisieren — 📅 geplant v0.11.48+
...
→ **Runtime-Gate: erreicht v0.11.48 ✅ · Web/AVRCP-Entry: Ziel v0.11.48**
...
|---|---|---|
| v0.11.48 | `trigger/` abschließen, IPC-Producer, Docs | ✅ |
| v0.11.48 | `integration/` kanonisieren, Web-Entry ablösen | 🔄 geplant |
| v0.11.48+ | `main_core.py` logisch zerlegen | 📅 nach Feldtest |
| v0.11.48+ | systemd Core-Entry modernisieren | 📅 später |
