...
**Stand v0.11.27 · Arbeitsorientiertes Migrationsdokument**
...
| `trigger/` | ✅ fast fertig | sauber seit v0.11.27 | keine aktiven | abgeschlossen erklären |
...
| `core/` (main_core) | ⚠️ noch fragil | bereinigt v0.11.27 | Root-Entry bleibt | erst logisch zerlegen |
...
### Block 1: `trigger/` abschließen — ✅ erledigt in v0.11.27
...
### Block 2: IPC-Producer vereinheitlichen — ✅ erledigt in v0.11.27/27
...
### Block 5: `main_core.py` logisch zerlegen — 📅 geplant v0.11.29+
...
→ **Runtime-Gate: erreicht v0.11.27 ✅ · Web/AVRCP-Entry: Ziel v0.11.28**
...
|---|---|---|
| v0.11.27 | `trigger/` abschließen, IPC-Producer, Docs | ✅ |
