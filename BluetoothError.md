...
| **v0.11.92** | **`hfp_ag` Rolle → `org.pipewire.Telephony` D-Bus Fehler → BT-Monitor blockiert** | **`hfp_ag` aus Rollen entfernt, nur `a2dp_source`; `org.pipewire.Telephony` in Policy** |
...
*Dokumentiert nach Debugging-Session v0.11.71–v0.11.92 · Juni 2026*
