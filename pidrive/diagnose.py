...
def check_services():
    ...
    nfo("pidrive_display.service: dauerhaft deaktiviert (TFT entfernt v0.11.8)")
...
def check_display_env():
    ...
    nfo("TFT-Display + GPIO dauerhaft entfernt v0.11.8")
...
def check_vtcon():
    ...
    if not __import__("os").path.isdir("/sys/class/vtconsole"):
        ...
        return
    # fbcon=nodeconfig: nicht mehr relevant (TFT-Display entfernt v0.11.8)
