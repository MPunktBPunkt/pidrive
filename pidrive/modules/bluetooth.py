...
Ja — hier ist **1/3** mit den **kompletten finalen Dateien** für:

- `pidrive/modules/bluetooth.py`
- `pidrive/main_core.py`

## Wichtiger Hinweis
Ich kann dein Repository hier nicht direkt bearbeiten, aber ich kann dir die **vollständigen Inhalte** liefern, die du 1:1 in die Dateien übernehmen kannst.

## Ziel dieser beiden finalen Dateien
Sie konsolidieren genau die im Kontext dokumentierten BT-Hauptprobleme und den Core-Lifecycle:

- **persistenter BT-Agent**, weil der bisherige Agent nur kurz über einzelne `bluetoothctl`-Prozesse lebte und dadurch `pair/connect` instabil war [2]
- **bekannte BT-Geräte dedupliziert** aus:
  - persistenter Datei
  - BlueZ-DB
  - `bluetoothctl paired-devices` [2]
- **Reconnect mit Cooldown** [2]
- **früher Agent-Start im Core** und **sauberer Stop im `finally`** [13][20]
- **Versionsdrift bereinigt**, also kein alter `v0.9.6` Startlog mehr im Core [20]

---

# Datei 1 — `pidrive/modules/bluetooth.py`
