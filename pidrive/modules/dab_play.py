#!/usr/bin/env python3
"""dab_play.py — DAB+ Wiedergabe via welle-cli  v0.10.8"""
...
def play_station(station, S, settings=None):
    ...
    try:
        ...
        # ── v0.10.3 (korrigiert): ALSA→PulseAudio-Routing für welle-cli ────────
        ...
        # v0.10.4: Audio-Routing-Debug beim Start
        _pa_default = ""
        try:
        ...
        for _ in range(lock_wait_max):
            ...
            # v0.10.4: _sess_err_file statt globalem ERR_FILE (Session-Isolation)
