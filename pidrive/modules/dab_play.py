#!/usr/bin/env python3
"""dab_play.py — DAB+ Wiedergabe via welle-cli  v0.10.50"""
...
def play_station(station, S, settings=None):
    ...
    try:
        ...
        # ── v0.10.50: Saubere ALSA-Umgebung für welle-cli ────────────────────
        ...
        # ── v0.10.50 (korrigiert): ALSA→PulseAudio-Routing für welle-cli ────────
        ...
        # v0.10.50: PULSE_SERVER wiederherstellen — PA System-Mode hält ALSA Card 1 exklusiv.
        ...
        # v0.10.50: Audio-Routing-Debug beim Start
        _pa_default = ""
        try:
        ...
        for _ in range(lock_wait_max):
            ...
            # v0.10.50: _sess_err_file statt globalem ERR_FILE (Session-Isolation)
...
def stop(S):
    ...
    if S.get("radio_type") == "DAB":
        S["radio_playing"] = False
        S["radio_station"] = ""
        # v0.10.50: Clear DLS/artist/track fields on stop to avoid stale display
        S["artist"] = ""
        S["track"] = ""
        S["dls_text"] = ""
        S["radio_name"] = ""
