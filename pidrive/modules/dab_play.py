#!/usr/bin/env python3
"""dab_play.py — DAB+ Wiedergabe via welle-cli  v0.10.30"""
...
def play_station(station, S, settings=None):
    ...
    try:
        ...
        # ── v0.10.30: Saubere ALSA-Umgebung für welle-cli ────────────────────
        ...
        # ── v0.10.30 (korrigiert): ALSA→PulseAudio-Routing für welle-cli ────────
        ...
        # v0.10.30: PULSE_SERVER entfernt — welle-cli läuft ALSA-direkt (stabiler)
        ...
        # v0.10.30: Audio-Routing-Debug beim Start
        _pa_default = ""
        try:
        ...
        for _ in range(lock_wait_max):
            ...
            # v0.10.30: _sess_err_file statt globalem ERR_FILE (Session-Isolation)
...
def stop(S):
    ...
    if S.get("radio_type") == "DAB":
        S["radio_playing"] = False
        S["radio_station"] = ""
        # v0.10.30: Clear DLS/artist/track fields on stop to avoid stale display
        S["artist"] = ""
        S["track"] = ""
        S["dls_text"] = ""
        S["radio_name"] = ""
