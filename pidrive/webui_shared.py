...
# -*- coding: utf-8 -*-
"""
webui_shared.py — Shared helpers für PiDrive WebUI Blueprints  v0.10.19
"""
...
# v0.10.19: IP-Cache (30s TTL) — verhindert Socket-Open bei jedem Request
_ip_cache: tuple = ("", 0.0)
...
def get_dab_status_debug():
    ...
    merged = {
        ...
        # v0.10.19: Audio-Routing-Debug aus play_debug.json
