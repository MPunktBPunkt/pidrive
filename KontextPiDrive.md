# PiDrive — Kontext & Projektdokumentation v0.9.29
...
### v0.9.29 — DAB: PULSE_ENV entfernt, Scanner: --ao=alsa
...
## Aktueller Stand (v0.9.29)

**System läuft stabil** — 26.04.2026:

```
✓ pidrive_core.service      v0.9.29 — install.sh git stash, Resume-Log, Volume-Parse, FM FastScan
✓ pidrive_display.service   v0.9.29, 20fps
