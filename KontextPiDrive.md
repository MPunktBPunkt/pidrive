# PiDrive — Kontext & Projektdokumentation v0.11.87
...
| MPRIS2 (BMW-Metadaten + Watchdog) | ✅ v0.11.87 — noch nicht im Auto validiert |
| Spotify Connect (librespot/raspotify) | ✅ OAuth vorhanden |
| USB-Musik + lokale Wiedergabe | ✅ v0.11.38 |
| **Audio-Stack: PipeWire System-Mode** | ✅ v0.11.87 — ersetzt System-PulseAudio |
| **BT-Pairing Auto-Confirm** | ✅ v0.11.87 — DisplayYesNo + yes-Handler |
...
| pidrivectl test all | ✅ v0.11.87 — Komplett-Systemtest |

---

## Audio-Stack: PipeWire System-Mode (ab v0.11.87)
...
| PipeWire | immer (ersetzt PulseAudio ab v0.11.87) |
...
## BT Pairing — Automatisch (v0.11.87)
...
### Audio / PipeWire
- **PipeWire System-Mode** ab v0.11.87 — `pulseaudio --system` komplett ersetzt
