...
### v0.10.24 — ROOT CAUSE GEFUNDEN: NaN/Infinity bricht gesamtes JavaScript
...
### v0.10.24 — JS-Fehlerdiagnose: globaler Error-Handler + console.log
...
### v0.10.24 — sendCmd Timing-Fix: Browser-Navigation funktioniert jetzt
...
### v0.10.24 — Menü-Fix komplett, Debug-Logging, Display-Guard
...
2. v0.10.24: `main_core.py` schrieb `menu.json` nur bei `needs_rebuild=True` — daher
...
### v0.10.24 — Navigation-Fix (Hauptfehler), DAB-Status, Display-Guard, Sudoers
...
### v0.10.24 — Root Cause Fix: PA-Setup ausserhalb Raspotify-Block, Diagnose-Kontext-Tests
...
### v0.10.24 — Code Review Fixes (P1/P2): BT, Dispatcher, Rebuild, Stale-State
...
### v0.10.24 — Debug-Tab Redesign, System-Diagnose, DAB Errfile, Webradio Metadaten
...
### v0.10.24 — Installer-Reihenfolge Fix, Log-Tab Fix, Diagnose-PA-Check
...
Fix v0.10.24: Bei Erstinstallation läuft Cleanup am Ende, gibt expliziten Hinweis
...
### v0.10.24 — Code Review Fixes, Installer Car-Only Cleanup, DAB ALSA-Direkt
