# PiDrive — Kontext & Projektdokumentation v0.11.93
...
| MPRIS2 (BMW-Metadaten + Watchdog) | ✅ v0.11.93 — noch nicht im Auto validiert |
| Spotify Connect (librespot/raspotify) | ✅ OAuth vorhanden |
| USB-Musik + lokale Wiedergabe | ✅ v0.11.38 |
| **Audio-Stack: PipeWire System-Mode** | ✅ v0.11.93 — ersetzt System-PulseAudio |
| **BT-Pairing Auto-Confirm** | ✅ v0.11.93 — DisplayYesNo + yes-Handler |
...
| pidrivectl test all | ✅ v0.11.93 — Komplett-Systemtest |

---

## Audio-Stack: PipeWire System-Mode (ab v0.11.93)
...
| PipeWire | immer (ersetzt PulseAudio ab v0.11.93) |
...
## BT Pairing — Automatisch (v0.11.93)
...
### Audio / PipeWire
- **PipeWire System-Mode** ab v0.11.93 — `pulseaudio --system` komplett ersetzt
