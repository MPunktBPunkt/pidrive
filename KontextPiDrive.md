# PiDrive — Kontext & Projektdokumentation v0.7.14
...
## TIOCSCTTY — Warum wir es NICHT verwenden (v0.7.14)
...
|---|---|---|
| Display dunkel | pygame auf fb0+fbcp Architektur — ersetzt durch fb1 direkt | main_display.py + pidrive_display.service (v0.7.14) |
...
| Service stirbt exit(0) | PAMName+StandardInput+root haengt systemd247 | Core ohne pygame (v0.7.14) |
| set_mode() haengt | SDL wartet auf VT in monolithischem Service | Core/Display Trennung + fb1 direkt (v0.7.14) |
...
## Aktueller Stand (v0.7.14)

**System laeuft stabil** — bestätigt 11.04.2026 (v0.7.14):
...
- [x] AVRCP BMW 118d 2017 NBT EVO → File-Trigger (v0.7.14)
- [x] MPRIS2 D-Bus → BMW-Display Metadaten (v0.7.14)
