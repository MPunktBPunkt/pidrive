# PiDrive — Kontext & Projektdokumentation v0.11.84
...
| MPRIS2 (BMW-Metadaten + Watchdog) | ✅ v0.11.84 — noch nicht im Auto validiert |
| Spotify Connect (librespot/raspotify) | ✅ OAuth vorhanden |
| USB-Musik + lokale Wiedergabe | ✅ v0.11.38 |
| **Audio-Stack: PipeWire System-Mode** | ✅ v0.11.84 — ersetzt System-PulseAudio |
| **BT-Pairing Auto-Confirm** | ✅ v0.11.84 — DisplayYesNo + yes-Handler |
...
| pidrivectl test all | ✅ v0.11.84 — Komplett-Systemtest |

---

## Audio-Stack: PipeWire System-Mode (ab v0.11.84)
...
| PipeWire | immer (ersetzt PulseAudio ab v0.11.84) |
...
## BT Pairing — Automatisch (v0.11.84)
...
### Audio / PipeWire
- **PipeWire System-Mode** ab v0.11.84 — `pulseaudio --system` komplett ersetzt
