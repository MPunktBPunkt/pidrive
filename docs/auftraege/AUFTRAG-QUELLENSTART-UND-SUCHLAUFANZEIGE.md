...
| 2026-09-16 | **Q-K/Q-L/Q-M umgesetzt** (v0.11.138): `mpris2.update(..., view=)`, `modules/menu_priority.py` + Core-Verdrahtung, `menu_view_window_s=3.5`, leaf beendet Fenster, `track_nr=1` im Menüzweig, Unit-Tests offline. **Q-N** (Fahrzeugkalibrierung HQ12) offen. |
| 2026-09-16 | **Q-G→Q-J umgesetzt** (v0.11.138): iDrive-Skript `fm-manual-freeze.txt` (zuerst rot mit Modal-Simulation); Raster `±0.1/±1.0 MHz` ersetzt `Frequenz manuell`/`freq_input_screen`; Q-J Force-Push nach FM-Abstimmung (`_mpris_force_push`). Freeze-Skript danach grün. |
| 2026-09-16 | **Q-A…Q-E umgesetzt** (v0.11.138): `enter_action` am MenuNode; nur Dispatcher bei enter/right; `source_autoplay` mit §2.2/§2.3/§2.4; genau drei Ordner (FM/DAB/Webradio); Walk/activate ohne Autoplay (Unit-Tests). |
